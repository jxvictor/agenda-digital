...
@Component({
  selector: 'app-compromisso-delete',
  templateUrl: './compromisso-delete.component.html',
  styleUrls: ['./compromisso-delete.component.css']
})
export class CompromissoDeleteComponent implements OnInit {
  ...
  create(): void {
    this.service.create(this.compromisso).subscribe((resposta: any) => {
      ...
      this.service.mensagem('Compromisso criado com sucesso!');
    }, (error: any) => {
      console.log(error);
    })
  }
